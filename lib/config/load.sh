...
load_config() {
  ...
  eval "$(node "$SCRIPTS_DIR/parse-config.js" "$config_path" 2>/dev/null || echo '')"
  ...
  MONOZUKURI_MAX_FEATURE_TOKENS="${CFG_FEATURES_MAX_FEATURE_TOKENS:-80000}"
  export MONOZUKURI_MAX_FEATURE_TOKENS
  PR_STRATEGY="${CFG_PR_CREATION_STRATEGY:-draft}"

  # Backlog scoring (ADR-024)
  MONOZUKURI_SCORING_PRIORITY_WEIGHT="${CFG_SCORING_PRIORITY_WEIGHT:-10}"
  MONOZUKURI_SCORING_AGE_WEIGHT="${CFG_SCORING_AGE_WEIGHT:-1}"
  MONOZUKURI_SCORING_EFFORT_WEIGHT="${CFG_SCORING_EFFORT_WEIGHT:-2}"
  export MONOZUKURI_SCORING_PRIORITY_WEIGHT
  export MONOZUKURI_SCORING_AGE_WEIGHT
  export MONOZUKURI_SCORING_EFFORT_WEIGHT
  ...
  MEMORY_AUTO_COMPACT_ENABLED="${CFG_MEMORY_AUTO_COMPACT_ENABLED:-true}"
  MEMORY_AUTO_COMPACT_MAX_ENTRIES="${CFG_MEMORY_AUTO_COMPACT_MAX_ENTRIES:-200}"
  MEMORY_AUTO_COMPACT_MAX_SIZE_BYTES="${CFG_MEMORY_AUTO_COMPACT_MAX_SIZE_BYTES:-100000}"
  export MEMORY_AUTO_COMPACT_ENABLED MEMORY_AUTO_COMPACT_MAX_ENTRIES MEMORY_AUTO_COMPACT_MAX_SIZE_BYTES
  ...
  SKILL_DISCOVERY="${CFG_DISCOVERY_SKILLS_ENABLED:-true}"
