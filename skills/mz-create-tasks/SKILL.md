...
- PRD at `$MONOZUKURI_WORKTREE/tasks/prd-$MONOZUKURI_FEATURE_ID/prd.md`
- TechSpec at `$MONOZUKURI_WORKTREE/tasks/prd-$MONOZUKURI_FEATURE_ID/techspec.md`
...
Write the task list to `$MONOZUKURI_WORKTREE/tasks/prd-$MONOZUKURI_FEATURE_ID/tasks.json` as a JSON array matching the schema in `references/tasks-schema.md`.
...
7. Write the task list as valid JSON to `$MONOZUKURI_WORKTREE/tasks/prd-$MONOZUKURI_FEATURE_ID/tasks.json`.
